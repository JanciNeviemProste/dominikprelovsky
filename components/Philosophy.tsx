...
const steps: Step[] = [
  ...
  },
  {
    ...
    text:
      "Som akreditovaný kondičný tréner (akreditovaný ministerstvom školstva) a športový tréner 2. kvalifikačného stupňa. Absolvoval som 4-ročné štúdium športovej prípravy na Športovom gymnáziu Jozefa Herdu v Trnave. Súťažím v kulturistike v kategórii Men's Physique — okrem vzdelania sa môžeš spoľahnúť aj na potrebnú prax.",
  },
  {
    number: "03",
    title: "Prax",
    text:
      "Bez ohľadu na certifikáty a vzdelanie je to najdôležitejšie osobná skúsenosť. Sám som si prešiel prípravami na súťaže v kategórii Men's Physique a umiestnil sa medzi top 3, kde steroidy neboli výnimkou. Naturálne sa mi podarilo maximalizovať výsledky sám na sebe — a od roku 2016 to prenášam na svojich klientov. Teraz pomôžem aj tebe.",
  },
];
