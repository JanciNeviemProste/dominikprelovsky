        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="font-body text-sm text-[var(--color-light-gray)] leading-relaxed">
              Fitness coach s 10 rokmi skúseností. Špecializácia na bodybuilding,
              transformáciu tela a výživu.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 mb-4">
              ...
              <li>
                <a
                  href="mailto:info@dominikprelovsky.sk"
                  className="font-body text-sm text-[var(--color-light-gray)] hover:text-[var(--color-primary)] transition-colors duration-200"
                >
                  info@dominikprelovsky.sk
                </a>
              </li>
            </ul>
            <div className="flex gap-4">
              <a
                href="https://www.instagram.com/fitcoach_dominprelovsky/"
                target="_blank"
